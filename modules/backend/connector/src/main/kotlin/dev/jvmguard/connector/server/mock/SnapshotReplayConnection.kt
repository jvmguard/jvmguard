...
import dev.jvmguard.connector.server.mock.snapshot.DemoSnapshot
...
class SnapshotReplayConnection(@Suppress("SpringJavaInjectionPointsAutowiringInspection") user: User) : MockServerConnectionImpl(user) {
    ...
    override fun moveTransactionTreeCursor(cursor: TransactionCursor, direction: dev.jvmguard.common.helper.Direction): TransactionCursor =
