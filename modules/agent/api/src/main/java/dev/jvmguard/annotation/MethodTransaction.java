 ...
 * Any invocation of the annotated method will create a transaction with the specified {@link #naming() naming}.
 * <p>
 * Overridden methods in derived classes are not instrumented unless the {@link #inheritance()} parameter is set
 * accordingly. If you specify {@code @MethodTransaction} on an abstract method, you have to set {@link #inheritance()} to
 * something other than {@code Mode.NONE}, otherwise no method will be instrumented.
 * </p>
 * <p>
 * See the <a href="{@docRoot}/dev/jvmguard/annotation/package-summary.html#package_description">package overview</a>
...
public @interface MethodTransaction {
     ...
     * </p>
     */
    Part[] naming() default {@Part(value = Type.CLASS, text = "."), @Part(Type.METHOD)};
     ...
     * By default, overridden methods are not instrumented. This means that an abstract annotated method
     * and overridden methods in derived classes that do not call {@code super()} will not generate any transactions.
     * <p>
     * If you set the inheritance parameter to something other than {@code Mode.NONE}, overridden
     ...
     * transactions. By default, no transactions generated from the same annotation are directly nested.
     */
    ReentryInhibition reentryInhibition() default ReentryInhibition.ANNOTATION;
}
