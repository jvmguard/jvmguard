 ...
 *
 * <p>
 * Defining a transaction is straightforward. Add {@link com.jvmguard.annotation.MethodTransaction @MethodTransaction} to a
 * method, then each method call will be shown as a transaction in jvmguard. If you have a class where all public methods
 * should be a transaction, annotate that class with {@link com.jvmguard.annotation.ClassTransaction @ClassTransaction}.
 * If some public methods in that class should be excluded, annotate them with
 * {@link com.jvmguard.annotation.NoTransaction @NoTransaction}.
 * </p>
 * <p>
 ...
 * {@link com.jvmguard.annotation.Part @Part} annotations as parameters to {@code @ClassTransaction} and
 ...
 * should be used for naming in that case? The {@link com.jvmguard.annotation.Inheritance @Inheritance} annotation is
 ...
 *
 * <p>
 * A custom telemetry is defined by annotating a static parameterless method with {@link com.jvmguard.annotation.Telemetry @Telemetry}.
 ...
 * </li>
 * <li>
 * If a filter of an {@link com.jvmguard.annotation.Inheritance inheritance} specification rejects the
 * instrumentation of a candidate method.
 * </li>
 * <li>
 * If an invalid parameter index is requested by a naming @Part of type
 * {@link com.jvmguard.annotation.Part.Type#PARAMETER}.
 * </li>
 * </ul>
 */
