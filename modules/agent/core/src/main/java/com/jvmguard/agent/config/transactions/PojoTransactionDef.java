...
public class PojoTransactionDef extends MethodInterceptionTransactionDef {
    ...
    public PojoDefinition createPojoDefinition() {
        ...
        return new PojoDefinition(declaringClassName, interceptSubclasses, singleMethod || methodInterceptionMode == MethodInterceptionMode.IMPLEMENTING_PUBLIC, singleMethod || staticMethods, singleMethod ? methodName : null, singleMethod ? methodSignature : null);
    }
