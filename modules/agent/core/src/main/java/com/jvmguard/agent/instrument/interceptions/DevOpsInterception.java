...
public abstract class DevOpsInterception extends AnnotationInterception {
    ...
    public DevOpsInterception(TransactionDefinition definition, Set<InterceptionMethod> noTransactionMethods, Handler handler, String declaringClassName) {
