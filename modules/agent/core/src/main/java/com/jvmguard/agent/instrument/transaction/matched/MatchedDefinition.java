...
public class MatchedDefinition extends TransactionDefinition {
    ...
    public MatchedDefinition(String declaringClassName, boolean interceptSubclasses, boolean onlyImplementingMethods, boolean staticMethods, String methodName, String methodSignature) {
        super(staticMethods);
    ...
    public boolean equals(Object o) {
        ...
        MatchedDefinition that = (MatchedDefinition)o;
