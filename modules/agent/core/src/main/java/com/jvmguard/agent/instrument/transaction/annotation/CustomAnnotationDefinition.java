...
public class CustomAnnotationDefinition extends AnnotationDefinition {
    private boolean inheritable;
    private boolean implementingOnly;
    private boolean useDeclaringClassName;
    private final TransactionType transactionType;

    public CustomAnnotationDefinition(String name, boolean methodAnnotation, boolean staticMethods, TransactionType transactionType) {
        super(name, methodAnnotation, staticMethods);
        this.transactionType = transactionType;
    }

    public CustomAnnotationDefinition inheritable(boolean inheritable) {
        this.inheritable = inheritable;
        return this;
    }

    public CustomAnnotationDefinition implementingOnly(boolean implementingOnly) {
        this.implementingOnly = implementingOnly;
        return this;
    }

    public CustomAnnotationDefinition useDeclaringClassName(boolean useDeclaringClassName) {
    ...
    public boolean equals(Object o) {
        ...
        CustomAnnotationDefinition that = (CustomAnnotationDefinition)o;
