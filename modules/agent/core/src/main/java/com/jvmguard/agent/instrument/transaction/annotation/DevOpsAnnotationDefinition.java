...
public class DevOpsAnnotationDefinition extends AnnotationDefinition {
    ...
    static {
        if (Boolean.getBoolean("jvmguard.server") || Boolean.getBoolean("jvmguard.obfuscated")) {
            CLASS_TRANSACTION_DESCRIPTOR = "L" + System.getProperty("jvmguard.int.devOpsClass", ClassTransaction.class.getName()).replace('.', '/') + ";";
            METHOD_TRANSACTION_DESCRIPTOR = "L" + System.getProperty("jvmguard.int.devOpsMethod", MethodTransaction.class.getName()).replace('.', '/') + ";";
            NO_TRANSACTION_DESCRIPTOR = "L" + System.getProperty("jvmguard.int.devOpsNo", NoTransaction.class.getName()).replace('.', '/') + ";";
            TELEMETRY_DESCRIPTOR = "L" + System.getProperty("jvmguard.int.devOpsTelemetry", Telemetry.class.getName()).replace('.', '/') + ";";
        } else {
    ...
    public DevOpsAnnotationDefinition(String name, boolean methodAnnotation, String groupName) {
    ...
    public static boolean isDevOpsDescriptor(String fullName) {
    ...
    public boolean isInheritable() {
        return false; // inheritable devops transactions are handled separately
    }
}
