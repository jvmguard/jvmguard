...
import com.jvmguard.integration.tests.jvmguard.pojo.classes.reentry.Reentry2
...
class PojoReentryTest : JvmGuardTest() {
    ...
    override fun connect(vmManager: TestVmManager, serverConnection: TestServerConnection, controller: Controller) {
        ...
        modifyCurrentRootConfig(serverConnection) { rootConfig ->
            ...
            (transactionDefs.first { it.id == 103L } as PojoTransactionDef).apply {
