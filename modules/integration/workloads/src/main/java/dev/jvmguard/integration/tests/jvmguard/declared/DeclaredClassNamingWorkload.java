...
public class DeclaredClassNamingWorkload extends AbstractJvmGuardRun {
    ...
    protected String[] getExpectedRetransformClasses(int newConfigNumber) {
        switch (newConfigNumber) {
            case 2:
                return new String[]{"dev.jvmguard.integration.tests.jvmguard.declared.classes.naming.ClassNaming3",
                    "dev.jvmguard.integration.tests.jvmguard.declared.classes.naming.ClassNaming1",
                    "dev.jvmguard.integration.tests.jvmguard.declared.classes.naming.Sub2ClassNaming1",
                    "dev.jvmguard.integration.tests.jvmguard.declared.classes.naming.Sub1ClassNaming1"};
            case 3:
                return new String[0];
        }
