...
import dev.jvmguard.integration.tests.jvmguard.mapped.classes.*;
...
public class MappedWorkload extends AbstractJvmGuardRun {
    ...
    protected String[] getExpectedRetransformClasses(int newConfigNumber) {
        switch (newConfigNumber) {
            case 2:
                return new String[]{"dev.jvmguard.integration.tests.jvmguard.mapped.classes.IncAnno1",
                    "dev.jvmguard.integration.tests.jvmguard.mapped.classes.IncAnno1Sub1",
                    "dev.jvmguard.integration.tests.jvmguard.mapped.classes.IncAnno3Sub1"};
        }
