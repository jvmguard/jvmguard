...
import dev.jvmguard.integration.tests.jvmguard.matched.classes.TestPolicyHelper;
import dev.jvmguard.integration.tests.jvmguard.matched.classes.policy.*;
...
public class MatchedPolicyWorkload extends AbstractJvmGuardRun {
    ...
    protected String[] getExpectedRetransformClasses(int newConfigNumber) {
        switch (newConfigNumber) {
            case 2:
                return new String[]{"dev.jvmguard.integration.tests.jvmguard.matched.classes.policy.Policy1Sub1" ,"dev.jvmguard.integration.tests.jvmguard.matched.classes.policy.Policy1"};
            case 3:
                return new String[]{"dev.jvmguard.integration.tests.jvmguard.matched.classes.policy.Policy1Sub2_2"};
        }
