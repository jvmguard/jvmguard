...
public class DeclaredMethodNamingSub2 extends DeclaredMethodNaming {
    ...
    @MethodTransaction(reentryInhibition = ReentryInhibition.DECLARED, group = "group3", naming = @Part(Type.METHOD))
    public void s2test1() {
    }
