...
@ClassTransaction(naming = {@Part(value = Type.CLASS, text = " "), @Part(value = Type.INSTANCE_CLASS, text = " "), @Part(Type.METHOD)}, group = "class1", reentryInhibition = ReentryInhibition.GROUP)
public class ClassNaming3 {
