...
import com.jvmguard.integration.tests.jvmguard.pojo.classes.naming.SubName1;
import com.jvmguard.integration.tests.jvmguard.pojo.classes.naming.SubName2;

public class PojoNamingWorkload extends AbstractJvmGuardRun {
    ...
    protected String[] getExpectedRetransformClasses(int newConfigNumber) {
        switch (newConfigNumber) {
            ...
            case 3:
                return new String[]{"com.jvmguard.integration.tests.jvmguard.pojo.classes.naming.Name1",
                    "com.jvmguard.integration.tests.jvmguard.pojo.classes.naming.SubName2",
                    "com.jvmguard.integration.tests.jvmguard.pojo.classes.naming.SubName1"};
        }
