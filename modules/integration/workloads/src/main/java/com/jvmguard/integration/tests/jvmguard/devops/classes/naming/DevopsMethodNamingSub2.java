...
public class DevopsMethodNamingSub2 extends DevopsMethodNaming {
    ...
    @MethodTransaction(reentryInhibition = ReentryInhibition.DEV_OPS, group = "group3", naming = @Part(Type.METHOD))
    public void s2test1() {
    }
