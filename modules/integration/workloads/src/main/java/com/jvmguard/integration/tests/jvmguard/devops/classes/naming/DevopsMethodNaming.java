...
public class DevopsMethodNaming {
    ...
    @MethodTransaction(inheritance = @Inheritance(Mode.WITH_SUBCLASS_NAMES), reentryInhibition = ReentryInhibition.DEV_OPS, group = "group2", naming = @Part(Type.METHOD))
    public void ntest6() {
        ntest5();
    }
    ...
    @MethodTransaction(reentryInhibition = ReentryInhibition.GROUP, group = "group1", naming = @Part(Type.METHOD))
    public static void ntest8(DevopsMethodNaming instance) {
        instance.pojo1();
        instance.pojo2();
        instance.pojo3();
    }
