...
import com.jvmguard.integration.tests.jvmguard.mapped.classes.*;

public class MappedWorkload extends AbstractJvmGuardRun {
    ...
    protected String[] getExpectedRetransformClasses(int newConfigNumber) {
        switch (newConfigNumber) {
            case 2:
                return new String[]{"com.jvmguard.integration.tests.jvmguard.mapped.classes.IncAnno1",
                    "com.jvmguard.integration.tests.jvmguard.mapped.classes.IncAnno1Sub1",
                    "com.jvmguard.integration.tests.jvmguard.mapped.classes.IncAnno3Sub1"};
        }
