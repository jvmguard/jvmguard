...
import com.jvmguard.integration.tests.jvmguard.matched.classes.policy.*;
...
public class MatchedPolicyWorkload extends AbstractJvmGuardRun {
    ...
    protected String[] getExpectedRetransformClasses(int newConfigNumber) {
        switch (newConfigNumber) {
            case 2:
                return new String[]{"com.jvmguard.integration.tests.jvmguard.matched.classes.policy.Policy1Sub1" ,"com.jvmguard.integration.tests.jvmguard.matched.classes.policy.Policy1"};
            case 3:
                return new String[]{"com.jvmguard.integration.tests.jvmguard.matched.classes.policy.Policy1Sub2_2"};
        }
