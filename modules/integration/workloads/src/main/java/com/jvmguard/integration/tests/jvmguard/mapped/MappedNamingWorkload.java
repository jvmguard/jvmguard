...
import com.jvmguard.integration.tests.jvmguard.mapped.classes.naming.Class1;
...
public class MappedNamingWorkload extends AbstractJvmGuardRun {
    ...
    protected String[] getExpectedRetransformClasses(int newConfigNumber) {
        switch (newConfigNumber) {
            case 2:
            case 3:
                return new String[]{"com.jvmguard.integration.tests.jvmguard.mapped.classes.naming.Class1",
                    "com.jvmguard.integration.tests.jvmguard.mapped.classes.naming.Class1Sub1"};
            case 4:
