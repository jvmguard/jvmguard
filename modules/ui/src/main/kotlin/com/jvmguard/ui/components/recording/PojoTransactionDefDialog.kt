...
import com.jvmguard.agent.config.transactions.PojoTransactionDef.InterceptionTarget
import com.jvmguard.agent.config.transactions.PojoTransactionDef.MethodInterceptionMode
...
class PojoTransactionDefDialog(
    def: PojoTransactionDef,
    isNew: Boolean,
    onSave: (PojoTransactionDef) -> Unit,
) : AbstractTransactionDefDialog<PojoTransactionDef>(def, isNew, onSave) {

    override val typeName: String get() = "POJO"
    ...
    override fun bindDefinition(binder: Binder<PojoTransactionDef>) {
    ...
    override fun readDefinition(def: PojoTransactionDef) {
        updateConditional()
    }
