...
import dev.jvmguard.ui.views.data.mbeans.AttributeEditDialog
...
class MBeansViewE2ETest : PlaywrightE2ETest() {
    ...
    fun rendersTheMBeanTreeForASingleVm() = onPage {
        ...
        // Also proves the reused folded dev.jvmguard.ui.views.data.mbeans helpers load in the ee11 web context.
